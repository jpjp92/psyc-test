...
const InfoModal: React.FC<InfoModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#1e1f20] rounded-[2rem] shadow-2xl w-full max-w-lg max-h-[calc(100dvh-2rem)] flex flex-col overflow-hidden relative animate-in zoom-in-95 duration-200 border border-transparent dark:border-[#444746]">

        {/* Header */}
        <div className="flex items-center justify-between p-5 md:p-6 border-b border-gray-100 dark:border-[#444746]/50">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-[#f0f4f9] dark:bg-[#28292a] border border-gray-200 dark:border-[#444746] p-3 rounded-xl flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-gray-100 dark:border-[#444746]/50 bg-white dark:bg-[#1e1f20] flex justify-end">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-3 bg-[#0b57d0] hover:bg-[#0b57d0]/90 dark:bg-[#a8c7fa] dark:hover:bg-[#8ab4f8] text-white dark:text-[#062e6f] font-bold rounded-2xl transition-all active:scale-95"
          >
            확인했어요
          </button>
        </div>
